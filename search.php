<?php
	...
	$sql = "SELECT * FROM job_item WHERE companyname = '$search'";
	...
	echo "<html>
			...
			if(mysqli_num_rows($result) > 0){
				...
				echo "<tr>";
				echo "<th align = 'right' width = '200px' style = 'padding:10px 10px;'><img src = 'images/$row[image]' width = '200px' height = '130px'></th>";
